...
class UpdateAppViewController: UIViewController {
    enum Style {
        ...
        var description: String {
            switch self {
            case .required:
                return "Your version of the Harmony Multisig Wallet app is not supported anymore since it is too old. Please update your app"
            case .recommended:
                return "Your version of the Harmony Multisig Wallet app will be deprecated soon. Please update your app."
            case .optional:
                return "There is an update of the Harmony Multisig Wallet app available"
            }
        }
